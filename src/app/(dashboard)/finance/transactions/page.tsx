    ...
    <div className="space-y-6">
        ...
        <div className="bg-amber-50 border border-amber-200 dark:bg-amber-500/5 dark:border-amber-500/20 rounded-xl p-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3 py-1.5 text-xs border border-amber-300 dark:border-amber-500/30 rounded-lg hover:bg-amber-100 dark:hover:bg-amber-500/10 transition-colors disabled:opacity-50"
            >
              <span className="font-medium text-amber-600 dark:text-amber-500">
                {autoCategorize.isPending ? "Working..." : "Auto-categorize"}
              </span>
              <span className="block text-[10px] text-amber-500/70 dark:text-amber-500/50">Rules &amp; matching</span>
            </button>
            <Link
              href="/finance/categorize"
              className="px-3 py-1.5 text-xs border border-card-border rounded-lg hover:bg-gray-100 dark:hover:bg-background-secondary transition-colors text-center"
            >
            ...
            <Link
              ...
              className="px-3 py-1.5 text-xs border border-card-border rounded-lg hover:bg-gray-100 dark:hover:bg-background-secondary transition-colors text-center flex flex-col items-center"
            >
      ...
      <div className="bg-card border border-card-border rounded-xl p-4">
        <div className="flex flex-wrap items-center gap-3">
          {/* Timeframe pills */}
          <div className="flex items-center gap-0.5 bg-gray-100 dark:bg-background-secondary border border-card-border p-0.5 rounded-lg">
          ...
          {category && (
            <button
              ...
              className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium text-foreground border transition-colors hover:bg-gray-100 dark:hover:bg-background-secondary"
              style={{
          ...
          <select
            ...
            className="px-3 py-1.5 rounded-lg bg-background-secondary border border-card-border text-xs text-foreground"
          >
          ...
          <div className="relative flex-1 min-w-[200px]">
            ...
            <input
              ...
              className="w-full pl-8 pr-8 py-1.5 rounded-lg bg-background-secondary border border-card-border text-xs text-foreground placeholder:text-foreground-muted/50"
            />
            {search && (
              <button
      ...
      {isLoading ? (
        ...
        <div className="bg-card border border-card-border rounded-xl overflow-hidden">
          {/* Elevated Header */}
          <div className="flex items-center gap-3 px-4 py-2.5 border-b border-card-border bg-gray-50 dark:bg-card-elevated text-[10px] text-foreground-muted font-medium uppercase tracking-widest">
          ...
          {data.transactions.map((tx) => (
            <TransactionRow
              ...
              paymentChannel={(tx as any).paymentChannel}
              authorizedDate={(tx as any).authorizedDate}
              logoUrl={(tx as any).logoUrl}
              website={(tx as any).website}
              location={(tx as any).location}
              counterparties={(tx as any).counterparties}
