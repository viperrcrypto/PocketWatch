...
export function InstitutionAccordion({
  ...
  return (
    <div className="bg-card border border-card-border rounded-xl overflow-hidden">
      ...
      <button
        onClick={onToggle}
        className="w-full flex items-center gap-3 px-5 py-3.5 hover:bg-gray-50/50 dark:hover:bg-white/[0.02] transition-colors"
      >
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          ...
          <div className="flex items-center gap-0.5" onClick={(e) => e.stopPropagation()}>
            <button
              ...
              className="p-1.5 rounded-md text-foreground-muted hover:text-foreground hover:bg-gray-100 dark:hover:bg-white/5 transition-colors"
              title="Sync"
            >
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  isActive ? "bg-primary/5" : "hover:bg-gray-50/50 dark:hover:bg-white/[0.02]"
                )}
              ...
              >
                ...
                {utilization != null && acct.creditLimit != null && (
                  <div className="w-20 flex-shrink-0 hidden sm:block">
                    <div className="w-full h-1 rounded-full bg-gray-200 dark:bg-background-secondary overflow-hidden">
                      <div
                        className={cn(
                          "h-full rounded-full",
