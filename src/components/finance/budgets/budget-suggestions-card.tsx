    ...
    <div className="bg-card border border-card-border rounded-2xl overflow-hidden flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto max-h-[480px] p-4">
        {slices.length === 0 ? (
          ...
          <>
            {/* Pure SVG donut — no library, no re-renders */}
            ...
            {/* Legend */}
            <div ref={legendRef} className="mt-3 grid grid-cols-2 gap-x-4 gap-y-1.5">
              {slices.map((item, idx) => (
                <div
                  key={item.name}
                  data-lidx={idx}
                  className="flex items-center gap-2 px-1.5 py-1 rounded-md cursor-default"
                ...
                >
                  ...
                  <span className="text-[11px] font-bold font-data tabular-nums text-foreground flex-shrink-0">
