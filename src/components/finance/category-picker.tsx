    ...
    <div className="bg-card border border-card-border rounded-xl p-3 space-y-2">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-8 pr-3 py-2 text-xs rounded-lg bg-background-secondary border-0 text-foreground placeholder:text-foreground-muted/60 focus:outline-none focus:ring-1 focus:ring-foreground/20"
        />
      </div>
