...
export function SubscriptionCard({
  ...
  accountType, institutionName, recentTransactions,
  onUpdateStatus, onToggleWanted, onRequestCancel, onUpdateNickname,
  onUpdateFrequency, onUpdateCategory, onDismiss,
              ...
              <div ref={freqPickerRef} className="relative">
                <button
                  ...
                  className={cn(
                    ...
                    FREQUENCY_COLORS[frequency] ?? "bg-gray-100 text-gray-600 dark:bg-gray-500/10 dark:text-gray-400"
                  )}
