      ...
      <div className="bg-card border border-card-border w-full max-w-sm p-6 rounded-xl">
        ...
        <div className="flex justify-end gap-3">
          ...
          <button
            ...
            disabled={isPending}
            className="px-5 py-2.5 min-h-[44px] bg-error text-white border border-error rounded-lg hover:bg-transparent hover:text-error transition-colors disabled:opacity-50 text-sm font-semibold"
          >
